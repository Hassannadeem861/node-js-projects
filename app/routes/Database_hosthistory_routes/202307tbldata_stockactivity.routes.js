module.exports = (app) => {
    ...
    const tbldata_stockactivity = require("../../controllers/Database_hosthistory_controller/202307tbldata_stockactivity.controller");
    ...
    app.use("/api/202307tbldata_stockactivity", router);
  };
