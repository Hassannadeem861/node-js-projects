module.exports = (app) => {
    ...
    const tbldata_current_tran = require("../../controllers/Database_hosthistory_controller/202307tbldata_current_tran.controller");
  //  const { verifyToken, isAdmin } = require("../middleware/authMiddleware");
    var router = require("express").Router();
  
    // Create a new tbldata_curr_ent_tran
    ...
    app.use("/api/202307tbldata_current_tran", router);
  };
