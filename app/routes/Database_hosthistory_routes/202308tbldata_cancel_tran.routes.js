module.exports = (app) => {
    ...
    const tbldata_cancel_tran = require("../../controllers/Database_hosthistory_controller/202308tbldata_cancel_tran.controller");
  //  const { verifyToken, isAdmin } = require("../middleware/authMiddleware");
    ...
    app.use("/api/202308tbldata_cancel_tran", router);
  };
