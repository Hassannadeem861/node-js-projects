module.exports = (app) => {
    ...
    const tbldata_adjustment = require("../../controllers/Database_hosthistory_controller/202307tbldata_adjustment.controller");
    ...
    app.use("/api/202307tbldata_adjustment", router);
  };
