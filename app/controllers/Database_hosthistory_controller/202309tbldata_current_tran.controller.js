// controllers/202309tbldata_current_tran.controller.js

const Tbldata_current_tran = require("../../models/Database_hosthistory_model/202309tbldata_current_tran.model");
...
exports.create = (req, res) => {
 ...
 const tbl_datacurrenttran = {
  ...
  Tbldata_current_tran.create(tbl_datacurrenttran)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
