const Tbldata_current_tran = require("../../models/Database_hosthistory_model/202401tbldata_current_tran.model");
...
exports.create = (req, res) => {
 ...
 const tbldata_currenttran = {
  ...
  Tbldata_current_tran.create(tbldata_currenttran)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
...
exports.findAll = (req, res) => {
  Tbldata_current_tran.findAll()
    .then((tbldatacurrent_trans) => {
      res.send(tbldatacurrent_trans);
    })
    .catch((err) => {
      res.status(500).send({
        message:
