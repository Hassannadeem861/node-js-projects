// controllers/202310tbldata_cashup_det.controller.js
const Tbldata_cashup_det = require("../../models/Database_hosthistory_model/202308tbldata_cashup_det.model");
// const Tbldata_cashup_det = db.tbldatacash_updet;
...
exports.create = (req, res) => {
 ...
 const tbldatacash_updet = {
  ...
  Tbldata_cashup_det.create(tbldatacash_updet)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
