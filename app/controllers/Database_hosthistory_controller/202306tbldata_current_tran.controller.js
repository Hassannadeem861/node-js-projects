const Tbldata_current_tran = require("../../models/Database_hosthistory_model/202306tbldata_current_tran.model");
...
clerkcashup: req.body.clerkcashup,
  ...
  // Save tbldata_current_tran in the tbldata_current_tran
  ...
  Tbldata_current_tran.findByPk(id)
    .then((data) => {
      if (data) {
        ...
        res.status(404).send({
          message: `Cannot find Tbldata_current_tran with id=${id}.`,
        });
      }
    })
    .catch((err) => {
