const Tbldata_cancel_tran = require("../../models/Database_hosthistory_model/202310tbldata_cancel_tran.model");
...
exports.create = (req, res) => {
  ...
  // Save Tbldata_cancel_tran in the database
  Tbldata_cancel_tran.create(tbl_data_cancel_tran)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
