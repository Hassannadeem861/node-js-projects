...
const Tbldata_stockactivity = require("../../models/Database_hosthistory_model/202308tbldata_stockactivity.model");
...
exports.create = (req, res) => {
 ...
 const tbldatastockactivity = {
  ...
  Tbldata_stockactivity.create(tbldatastockactivity)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
