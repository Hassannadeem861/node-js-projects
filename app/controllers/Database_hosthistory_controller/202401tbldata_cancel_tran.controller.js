const Tbldata_cancel_tran = require("../../models/Database_hosthistory_model/202401tbldata_cancel_tran.model");
...
exports.create = (req, res) => {
  ...
  Tbldata_cancel_tran.create(tbldata_canceltran)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
