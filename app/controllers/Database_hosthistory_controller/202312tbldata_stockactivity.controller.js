const Tbldata_stockactivity = require("../../models/Database_hosthistory_model/202312tbldata_stockactivity.model");
...
exports.create = (req, res) => {
 ...
 const tbldata_stock_activity = {
  ...
  Tbldata_stockactivity.create(tbldata_stock_activity)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
