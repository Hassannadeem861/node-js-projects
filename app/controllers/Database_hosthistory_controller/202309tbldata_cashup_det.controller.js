...
const Tbldata_cashup_det = require("../../models/Database_hosthistory_model/202309tbldata_cashup_det.model");
...
exports.create = (req, res) => {
 ...
 const tbldatacashupdet = {
  ...
  Tbldata_cashup_det.create(tbldatacashupdet)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
